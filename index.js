      ...
      try {
        ...
        const stageInfo = {
          ...
          response: {
            ...
            ask: "実際に行った対応だけを確認し、行っていない対応を推測しない。家族への報告や上司への報告は、この項目では記入・質問の対象にしない"
          },
          user_status: {
            title: "利用者の状況",
          ...
          cause: {
            ...
            ask: "原因を断定せず、Excelと確定した内容から考えられる要因を整理する。AIだけで最終判断しない"
          },
          prevention: {
            title: "再発防止策",
