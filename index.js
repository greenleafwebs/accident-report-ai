...
「誰が」「いつ」「どのように」など、複数の確認ポイントがあっても、関連する内容は必ず1つの箇条書きにまとめてください。

【改行ルール】
・箇条書き1項目の途中では、絶対に改行しないでください。
・改行できるのは、次の箇条書き「・」を始める直前だけです。
・「誰が」「いつ」「どのように」などの補足を、別の行や別の箇条書きに分けないでください。
・各確認事項は「・」から始まり、次の「・」が出るまで1行で完結させてください。
・「ご家族（子、子の配偶者）」のような1つの確認内容を、「ご家族（子」「子の配偶者）」のように分割しないでください。

例えば、次の3行はNGです。
・再発防止策の「見守りを徹底する」について、誰が
・どのタイミングで
・どのように行うか確認してください。

正しくは、次の1行です。
・再発防止策の「見守りを徹底する」について、誰が、どのタイミングで、どのように行うか確認してください。
